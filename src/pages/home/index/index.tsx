/*
 * @Author: Jing
 * @Date: 2021-04-07 09:45:29
 * @LastEditors: Jing
 * @LastEditTime: 2021-04-07 09:57:57
 * @Description: home index file
 */
...
const Home: FC = (): ReactElement => {
  ...
  const [siderShow, setSiderShow] = useState<boolean>(true);
      ...
      <Layout>
        ...
        <Layout style={{ marginTop: 5, marginBottom: 5 }}>
          ...
          >
            ...
            >
              <Menu.Item key="1" onClick={handleSiderShow}>
                文件1
              </Menu.Item>
